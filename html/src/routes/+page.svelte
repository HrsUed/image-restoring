  ...
  <div class="util-panels">
    <div class="panel">
      ...
      <div class="parameters">
        ...
        >
        <ParameterInput
          bind:parameterValue={nishimoriInverseTemperature}
          step={0.01}
          disabled={true}>西森逆温度</ParameterInput
        >
        <ParameterInput bind:parameterValue={restorationInverseTemperature} step={0.1}
          >修復逆温度</ParameterInput
        >
        ...
        <ParameterInput bind:parameterValue={iterationCount} step={1} disabled={true}
          >反復回数</ParameterInput
        >
      </div>
    </div>
    ...
    <div class="panel">
      ...
      <div class="actions">
        ...
        <button type="button" on:click={restoreImage} disabled={degradedImage.isBlank()}
          >修復する</button
        >
...
<style>
  ...
  :global(body.silent-night) .panel {
    box-shadow: 0 5px 10px 1px rgba(255, 255, 255, 0.14);
  }
